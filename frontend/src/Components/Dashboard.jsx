...
import { exportToExcelKotak } from '../Pages/Kotak Bank/Export_To_Excel_Kotak';
import { exportToCSVKotak } from '../Pages/Kotak Bank/Export_TO_Csv_Kotak';
...
const [month, setMonth] = useState(currentMonth);
  ...
  const handleDownload = () => {
    exportToExcelKotak(formattedData, 'Transaction_Report');
  };

    const handleDownloadCSV = () => {
    exportToCSVKotak(pdfData, 'Transaction_Report');
  };
