...
import { exportToExcelAxis } from './Export_To_Excel_Axis';
import { exportToCSVAxis } from './Export_To_Csv_Axis';


function Axis_Bank_Pdf_Data() {
...
const getNarrationParts = (narration, refNo) => {
  ...
  const handleRemarkChange = (e, refNo) => {
    ...
    const exportToExcel = ()=>{
        exportToExcelAxis(formattedData)
    }
    const exportToCSV = ()=>{
        exportToCSVAxis(pdfData)
    }
...
export default Axis_Bank_Pdf_Data
